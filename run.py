...
st.session_state.label_dict = {
    '장점': {
                '배려': "배려, 동료 사람, 열린마음, 공평, 평등, 소통, 커뮤니케이션, 의사소통, 존중, 선한, 착한",
                '목표': "목표, 목표의식, 이상주의, 원대한, 비전, 새로운 시도, 진취",
                '학습': "신기술, 미래,  세상을 바꾼다, 최신 트렌드, 동향에 민감, 선도",
                '즐거움': "재미, 젊음, 즐거움, 자유, 얽매이지 않음, 유연한 사고,위트, 특색, 개성",
                '결과': "성과, 성과금, 금전적 보상, 속도, 실적, 전략, 집중,  결과, 성취감, 실력",
                '권위': "권위, 대담, 결단, 지배",
                '안전': "안정, 신중, 대비, 교육, 보고",
                '질서': "규칙, 룰, 틀, 전문성, 관리, 문서화, 체계, 정확성"
    },
    '단점': {
