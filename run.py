...
st.session_state.label_dict = {
    '장점': {
                "도전": "개척, 모험, 과감한 시도, 위험 감수, 변화 선도",
                "전문성": "최고, 자기개발, 전문가, 현장 지식, 프로, 실력, 탁월, 경쟁력 ",
                "창의성": "상상, 인식 전환, 독창성, 가치 창출, 혁신, 창조적 사고 등",
                "소통/협력": "동료애, 공동체 의식, 팀워크, 대인관계, 시너지, 협업, 배려 등",
                "원칙": "도덕성, 정직, 무결점, 공정, 기본, 정도",
                "열정": "승부근성, 체력, 건강, 자신감, 진취 등",
                "책임감": "책임감, 성실성, 사명감, 고객중심, 고객만족 등",
                "글로벌역량/개방성": "열린사고, 국제적 소양,  어학 능력, 다양성, 다문화 이해, 글로벌 비즈니스, 미래, 유연한 사고 등",
                "신뢰": " 존중,  믿음, 약속",
                "사회공헌": "사회적 책임, 사회적 발전, 사회적 가치, 사회적 신회, 봉사, 상생, 사회적 역할 등"
    },
    '단점': {
                "도전": "개척, 모험, 과감한 시도, 위험 감수, 변화 선도",
                "전문성": "최고, 자기개발, 전문가, 현장 지식, 프로, 실력, 탁월, 경쟁력 ",
...
with st.container():
    default_candidate_labels = ["도전", "전문성", "창의성", "소통/협력", "원칙", "열정", "책임감", "글로벌역량/개방성", "신뢰", "사회공헌"]
